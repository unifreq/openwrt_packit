...
INDEX_PATCH_HOME="${PWD}/myfiles/immortalwrt.index.patches"
GETCPU_SCRIPT="${PWD}/files/getcpu"
TTYD="${PWD}/files/ttyd"
FLIPPY="${PWD}/files/scripts_deprecated/flippy_cn"
BANNER="${PWD}/myfiles/immortalwrt.banner"
...
# 20210330 add
DOCKERD_PATCH="${PWD}/myfiles/docker.patch"
...
# 20210704 add
SYSINFO_SCRIPT="${PWD}/myfiles/30-sysinfo.sh"
...
# 20211019 add
FIRSTRUN_SCRIPT="${PWD}/myfiles/first_run.sh"
