...
###################################################################
KERNEL_TAGS="rk3576"
KERNEL_BRANCHES="bsp:rk3576:>=:6.1 mainline:all:>=:6.12"
...
DAEMON_JSON="${PWD}/files/rk3576/100ask-dshanpi-a1/daemon.json"
...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3576/100ask-dshanpi-a1/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3576/100ask-dshanpi-a1"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3576/100ask-dshanpi-a1/bootloader.bin"
...
FORCE_REBOOT="${PWD}/files/rk3576/100ask-dshanpi-a1/reboot"
...
# 20220906 add
PWM_FAN="${PWD}/files/rk3576/100ask-dshanpi-a1/pwm-fan.pl"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3576/modules.d"
# 20221022
BOARD_HOME="${PWD}/files/rk3576/100ask-dshanpi-a1/board.d"
# 20230801 add
BOARD_MODULES_HOME="${PWD}/files/rk3576/100ask-dshanpi-a1/modules.d"
####################################################################
