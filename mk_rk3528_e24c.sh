...
#KERNEL_VERSION=5.10.160-rk35xx-flippy-2504a
...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3528/e24c/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3528/e24c"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3528/e24c/bootloader.bin"
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3528/e24c/board.d"
# 20221001 add
