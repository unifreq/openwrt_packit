...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3528/rs6pro/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3528/rs6pro"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3528/rs6pro/bootloader.bin"
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3528/rs6pro/board.d"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3528/modules.d"
# 20221123 add
BOARD_MODULES_HOME="${PWD}/files/rk3528/rs6pro/modules.d"
# 20221013 add
WIRELESS_CONFIG="${PWD}/files/rk3528/rs6pro/wireless"
####################################################################
