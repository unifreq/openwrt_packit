...
DAEMON_JSON="${PWD}/files/rk3588s/e54c/daemon.json"
...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3588s/e54c/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3588s/e54c"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3588s/e54c/bootloader.bin"
...
FORCE_REBOOT="${PWD}/files/rk3588s/e54c/reboot"
...
# 20220906 add
PWM_FAN="${PWD}/files/rk3588s/e54c/pwm-fan.pl"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3588s/modules.d"
# 20221022
BOARD_HOME="${PWD}/files/rk3588s/e54c/board.d"
# 20230801 add
BOARD_MODULES_HOME="${PWD}/files/rk3588s/e54c/modules.d"
# 20250505 add
RC_BUTTON_HOME="${PWD}/files/rk3588s/e54c/rc.button"
####################################################################
