...
# CONFIG_PACKAGE_luci-i18n-ocserv-bn_BD is not set
...
CONFIG_PACKAGE_luci-i18n-ocserv-en=y
...
# CONFIG_PACKAGE_luci-i18n-ocserv-nb_NO is not set
# CONFIG_PACKAGE_luci-i18n-ocserv-pl is not set
# CONFIG_PACKAGE_luci-i18n-ocserv-pt is not set
# CONFIG_PACKAGE_luci-i18n-ocserv-pt_BR is not set
...
# CONFIG_PACKAGE_luci-i18n-ocserv-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-socat-zh_Hans is not set
...
CONFIG_OVERRIDE_PKGS="luci-app-pptp-server luci-app-serverchan luci-lib-fs luci-theme-bootstrap microsocks"
