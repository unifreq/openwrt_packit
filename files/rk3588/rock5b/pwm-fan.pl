...
sub init {
    ...
    open $fh, ">", "/sys/class/pwm/pwmchip1/export";
    print $fh "0\n";
    close $fh;

    open $fh, ">", "/sys/class/pwm/pwmchip1/pwm0/period";
    print $fh "$period\n";
    close $fh;

    open $fh, ">", "/sys/class/pwm/pwmchip1/pwm0/polarity";
    print $fh "normal\n";
    close $fh;

    open $fh, ">", "/sys/class/pwm/pwmchip1/pwm0/enable";
    print $fh "1\n";
    close $fh;
}
...
sub set_fixed_speed {
    ...
    open my $fh, ">", "/sys/class/pwm/pwmchip1/pwm0/duty_cycle";
    print $fh "$duty_cycle\n";
    close $fh;
}
