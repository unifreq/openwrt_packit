...
export KERNEL_VERSION=6.1.115-rk35xx-flippy-2504a
...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3566/netfusion/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3566/netfusion"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3566/netfusion/bootloader.bin"
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3566/netfusion/board.d"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3566/modules.d"
# 20221123 add
BOARD_MODULES_HOME="${PWD}/files/rk3566/netfusion/modules.d"
# 20221013 add
WIRELESS_CONFIG="${PWD}/files/rk3566/netfusion/wireless"
####################################################################
